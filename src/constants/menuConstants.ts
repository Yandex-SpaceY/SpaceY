...
import { GAME_OPTIONS } from './gameConstants';
...
export const enum MENU_ACTIONS {
  ...
  GAME_SKILL_SWITCH = 'GAME_SKILL_SWITCH',
...
export const MENU_ITEMS: TMenuItem[] = [
  ...
  { title: GAME_OPTIONS.SKILL_TITLE, route: null, action: MENU_ACTIONS.GAME_SKILL_SWITCH },
  ...
  { title: GAME_OPTIONS.THEME_TITLE, route: null, action: MENU_ACTIONS.GAME_THEME_SWITCH },
];
